...
app.listen(3100, () => {
  ...
  console.log('TA RODANDO CARAI');
  console.log('------------------------------------------------------');
});

app.route('/api/courses').get((request, response) => {
  response.send(COURSES);
  console.log("CALL app.route('/api/courses').get((request, response) => ")
...
app.route('/api/courses').post((request, response) => {
  ...
  console.log("CALL app.route('/api/courses').post((request, response) => ")
  console.log('------------------------------------------------------');
});
...
app.route('/api/courses/:id').put((request, response) => {
  ...
  console.log("CALL app.route('/api/courses/:id').put((request, response) => ")
  console.log('------------------------------------------------------');
});
...
app.route('/api/courses/:id').get((request, response) => {
  ...
  console.log("CALL app.route('/api/courses/:id').get((request, response) =>")
  console.log('------------------------------------------------------');
});
...
app.route('/api/courses/:id').delete((request, response)=> {
  ...
  console.log("CALL app.route('/api/courses/:id').delete((request, response)=> ")
  console.log('------------------------------------------------------');
});
